...
const Home = () => {
  return (
    <div className="relative flex min-h-[calc(100vh-80px)] flex-col items-center justify-center text-center overflow-hidden">
      <GridPattern
        ...
        y={0}
        className={cn(
          "[mask-image:linear-gradient(to_bottom_right,rgba(0,0,0,0.2),rgba(0,0,0,1))] absolute inset-0 -z-10"
        )}
      />
